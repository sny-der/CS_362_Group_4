...
class messaging_app(ctk.CTk):
    def __init__(self):
        ...
        self.title("P2Ping - Peer-to-Peer Messaging and File Sharing")
        ...
        # Sidebar for conversations and contacts, currently not implemented with real data, just mockups for now.
        """
        ...
        self.file_btn = ctk.CTkButton(self.action_bar, text="📁 Send File", width=100)
        self.file_btn.pack(side="left", padx=5)

        self.clear_btn = ctk.CTkButton(self.action_bar, 
    ...
    def clear_chat(self):
        """Clears the chat display. Useful for starting new conversations."""
